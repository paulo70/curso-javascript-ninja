...
var pessoa = {
   ...
   caminhouQuantosMetros: function(){
     return 0;
   }
}
...
*/
 ...
 pessoa.andar = function(m) {
      pessoa.caminhouQuantosMetros + m + ' metros';
      pessoa.andando = true;
}
...
*/
 ...
 pessoa.nomeCompleto(); // Olá meu nome é james bond!
...
*/
 ...
 pessoa.andar(150); // 150 metros
 pessoa.andar(100); // 100 metros
 pessoa.andar(50);  // 50 metros
...
*/
 ...
 pessoa.apresentacao = function() {
    ...
    return 'Olá, eu sou ' + sexo + ' '  
          + pessoa.nome + ' tenho ' + pessoa.idade + ' ' + idade + ' ' 
